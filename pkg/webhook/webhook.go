...
const (
	admissionWebhookAnnotationStatusKey = "sidecar-injector-webhook.juice.com/status"
)
...
func (whServer *Server) mutate(ar *v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
	req := ar.Request
	var pod corev1.Pod
...
func (whServer *Server) Serve(w http.ResponseWriter, r *http.Request) {
	var body []byte
	if r.Body != nil {
